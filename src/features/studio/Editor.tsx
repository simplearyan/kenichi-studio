                        ...
                        <div>
                            ...
                            <div className="flex p-1 bg-white rounded-lg border border-slate-200 shadow-sm">
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-md text-xs font-medium transition-all ${variant === 'corporate'
                                ...
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-md text-xs font-medium transition-all ${variant === 'hand-drawn'
                                            ? 'bg-slate-100 text-slate-900 shadow-inner'
                                            : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`flex-1 flex items-center justify-center gap-2 py-2 rounded-md text-xs font-medium transition-all ${variant === 'neon'
                                            ? 'bg-slate-100 text-slate-900 shadow-inner'
                                            : 'text-slate-500 hover:text-slate-900 hover:bg-slate-50'
                                        }`}
                                >
